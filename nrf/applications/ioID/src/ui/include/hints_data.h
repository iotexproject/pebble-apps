...
const uint8_t *deviceRegister[]={deviceRegister_en, deviceRegister_cn, sizeof(deviceRegister_cn)};

#ifdef IOTEX_SPROUT_COMMUNICATE_PROTOCOL_USE_DIDCOMM
const uint8_t getDiddocErr_en[] = "Failed to get diddoc from server";
const uint8_t getDiddocErr_cn[] = {
};
const uint8_t *getDiddocErr[]={getDiddocErr_en, getDiddocErr_cn, sizeof(getDiddocErr_cn)};

const uint8_t getTokenErr_en[] = "Failed to get Token from server";
const uint8_t getTokenErr_cn[] = {
};
const uint8_t *getTokenErr[]={getTokenErr_en, getTokenErr_cn, sizeof(getTokenErr_cn)};
#endif

const uint8_t httpConnectErr_en[] = "Failed to connect to the server";
const uint8_t httpConnectErr_cn[] = {
};
const uint8_t *httpConnectErr[]={httpConnectErr_en, httpConnectErr_cn, sizeof(httpConnectErr_cn)};

const uint8_t getServerInfoErr_en[] = "Failed to retrieve server information";
const uint8_t getServerInfoErr_cn[] = {
};
const uint8_t *getServerInfoErr[]={getServerInfoErr_en, getServerInfoErr_cn, sizeof(getServerInfoErr_cn)};
