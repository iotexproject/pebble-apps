...
enum COM_COMMAND
{
    ...
    COM_CMD_DOWNLOAD_CHAN,
    COM_CMD_DOWNLOAD_GPS,
    COM_CMD_DOWNLOAD_ENDP_INDEX,
    COM_CMD_DOWNLOAD_M_ENDP,
    COM_CMD_DOWNLOAD_T_ENDP,
    COM_CMD_DOWNLOAD_M_CERT,
    COM_CMD_DOWNLOAD_M_KEY,
    COM_CMD_DOWNLOAD_M_ROOT,
    COM_CMD_DOWNLOAD_T_CERT,
    COM_CMD_DOWNLOAD_T_KEY,
    COM_CMD_DOWNLOAD_T_ROOT,
    COM_CMD_SYS_REBOOT,
    COM_CMD_UPLOAD_INFO_ACK,
    COM_CMD_LAST
};
